...
| 16 | framework 過度 emphasize US-centric「RFP」、忽略台灣 SI 慣用 5-stage 流程 | framework default 大企業 procurement、不對應台灣中小企業 SI 接案實情 | 加台灣 SI 5-stage 流程：初步提案 → 需求訪談 → **完整提案 (SA + 功能 + 報價)** → 簽約 → 施工/驗收/上線；RFP 作 sub-stage doc (僅大企業 / 政府用) | AP-4 翻車 #16 + AP-NEW-WRITE-5.e 加台灣 SI 流程 awareness |
