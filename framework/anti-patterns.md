...
- **教訓**：
  ...
  - 案例（per Amafans EAQS 2026-05-29 retro、本 session 累計 4 次翻車）：
    ...
    - 翻車 #10：§2「無 peer 修正」/「模組 01-02 N/A」這類 dense claim 寫完、user 一句「什麼意思」就 trigger explain — dense claim 沒配 inline example、reviewer 必問（→ commit checkpoint #9：dense claim 後一定加 ❌/✅ phrasing example or 2×2 table 拆 case、documentation clarity 默認姿態）
