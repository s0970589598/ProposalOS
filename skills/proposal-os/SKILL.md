---
name: proposal-os
description: 用 ProposalOS 框架引導完整顧問式系統提案流程 + 結案 retrospect 累積機制。跨產業通用（製造、醫療、政府、金融、零售、能源 ESG、食品物流、SaaS、營建）。從產業研究、競品分析、訪談、RTM、架構、報價到反方審查；結案後引導 retrospect 累積 anti-patterns。觸發：「幫我寫提案」「新案件 kickoff」「ProposalOS」「proposal-os」「consultative proposal」「顧問式提案」「proposal flow」「系統提案規劃」「X 案結束了」「X 案輸了」「X 案贏了」「X 案簽約了」「X 案上線了」「X 案暫停了」「跑 retrospect」「結案復盤」。
---
