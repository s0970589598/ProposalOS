...
- **13 大模組**：產業 / 競品 / 問題 / 流程 / 角色 / 資料 / 合規 / 架構 / 方案 / 商務 / 驗收 / 風險 / **系統設計 MVP**（Phase 7、高 spec 案件用）
...
2. **先做** [framework/modules/01-industry-market.md](framework/modules/01-industry-market.md) 到 03
